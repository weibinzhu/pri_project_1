  ...
  <div class="releaseTaskWrapper">
    ...
    <div class="taskInfoBlock">
      ...
      <div class="taskInfoPrice">
        ...
        <input v-model="price" type="text" placeholder="填写价格（元/次）" name="price"/>
      </div>
    </div>
    <div class="taskInfoBlock">
    ...
    <div class="taskInfoBlock">
      ...
      <div class="chooseImageWrapper">
        <!--<img class="imagePreview" :src="image" v-for="(image,index) in imagesPreview">-->
        <div class="imagePreview" v-for="(item,index) in imagesPreview"
             :style="{backgroundImage: 'url(' + item + ')'}">
          <img @click="deleteImg(index)" src="/static/Close@3x.png"/>
        </div>
        <div class="chooseImage" v-show="imagesPreview.length<5">
          <input id="image" type="file" placeholder="choose image" @change="uploadPhoto"/>
...
<script type="text/ecmascript-6">
  ...
  import {uploadPhoto} from '@/common/utils/utils.js'
  ...
  export default {
    ...
    methods: {
      ...
      uploadPhoto(e) {
        ...
        uploadPhoto.call(this, file, `${this.globalDOMAIN}Api/File/picUploader`, this.token, this.imagesPreview, this.imagesSent)
      },// 上传图片
      deleteImg(index) {
        this.imagesSent.splice(index, 1)
